...
all: Rectangle.o sprite_rect_buffer.o position.o entity.o entity_factory.o ship.o ship_state_transitions.o fuel_tank.o radar_tower.o gun_ver.o gun_hor_north.o gun_hor_south.o parked_plane.o cube_back.o cube_front.o cube_back_ver.o cube_front_ver.o cube_back_hor.o cube_front_hor.o cube_ship_back.o cube_ship_front.o state_machine.o game_manager.o sprite.o entity_sprite_sheet_animation.o entity_sprite_sheet.o entity_data_manager.o
...
cube_back.o: src/entities/cube_back.cpp
	$(CXX) -c $(CFLAGS) src/entities/cube_back.cpp
...
cube_ship_back.o: src/entities/cube_ship_back.cpp
	$(CXX) -c $(CFLAGS) src/entities/cube_ship_back.cpp

cube_ship_front.o: src/entities/cube_ship_front.cpp
	$(CXX) -c $(CFLAGS) src/entities/cube_ship_front.cpp
