...
constexpr float ZERO_NUMBER_Y = 230.0f;                                          // Y coordinate of the zero-number sprite in the tilemap.
constexpr float ALPHABET_X = 0.0f;                                               // X coordinate of the A letter sprite in the tilemap.
constexpr float ALPHABET_Y = 230.0f;                                             // Y coordinate of the A letter sprite in the tilemap.
