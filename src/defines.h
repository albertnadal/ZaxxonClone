...
enum EntityIdentificator: uint16_t { NONE = 0, SHIP = 1, FUEL_TANK = 2, RADAR_TOWER = 3, GUN_VERTICAL= 4, GUN_HORIZONTAL_NORTH = 5, GUN_HORIZONTAL_SOUTH = 6, PARKED_PLANE = 7, CUBE_BACK = 8, CUBE_FRONT = 9, CUBE_BACK_VERTICAL = 10, CUBE_FRONT_VERTICAL = 11, CUBE_BACK_HORIZONTAL = 12, CUBE_FRONT_HORIZONTAL = 13, CUBE_SHIP_BACK = 14, CUBE_SHIP_FRONT = 15 };
...
enum CubeShipBackAnimation: uint16_t { CUBE_SHIP_BACK_QUIET = 21 };
